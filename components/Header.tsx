        ...
        <nav className="flex items-center justify-between gap-3 sm:gap-6">
          ...
          >
            ...
            <div className="hidden sm:block">
              <h1 className="text-xl font-semibold text-gray-900 dark:text-white">DevTool</h1>
              <p className="text-sm text-gray-600 dark:text-gray-400">Changelog</p>
            </div>
          </Link>
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 flex-shrink-0">
            <Link 
              href="/"
              className="hidden lg:block text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium transition-colors text-sm"
            >
              Changelog
            </Link>
            <a 
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium transition-colors text-sm flex items-center gap-1 sm:gap-2"
            >
