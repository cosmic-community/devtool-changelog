  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-x-4 top-20 mx-auto max-w-2xl">
        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-2xl">
          {/* Search Input */}
          <div className="relative border-b border-gray-200 dark:border-gray-700">
            ...
            <input
              ref={inputRef}
              type="text"
              placeholder="Search releases, versions, changes..."
              value={searchTerm}
          ...
          >
            {searchTerm && results.length === 0 && (
              <div className="p-8 text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-500 mt-1">Try searching for version numbers, feature names, or release content.</p>
              </div>
            )}
                ...
                {results.map((result, index) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded flex items-center justify-center mt-0.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-1">
                          ...
                          <span>•</span>
                          <span>{new Date(result.item.metadata?.release_date || result.item.created_at).toLocaleDateString()}</span>
                        </div>
            ...
            {!searchTerm && (
              <div className="p-8 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400">Start typing to search releases</p>
                <div className="mt-4 flex flex-wrap gap-2 justify-center text-sm text-gray-500 dark:text-gray-500">
